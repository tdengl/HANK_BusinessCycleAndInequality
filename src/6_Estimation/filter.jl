...
"""
# par, Data, Data_miss, H_sel, XSSaggr, A, B, indexes,indexes_aggr, m_par, n_par, e_set, distrSS, compressionIndexes, priors, meas_error, meas_error_std = par, Data, Data_missing, H_sel, XSSaggr,A,B, indexes, indexes_aggr, m_par, n_par, e_set, distrSS, compressionIndexes, priors, meas_error, meas_error_std 
function likeli(par, Data, Data_miss, H_sel, XSSaggr, A, B, indexes,indexes_aggr, m_par, n_par, e_set,distrSS, compressionIndexes, priors, meas_error, meas_error_std; smoother=false)
    ...
    if alarm_prior
        ...
        # BLAS.set_num_threads(1) # sets number of threads specifically for functions in BLAS?
        ...
        # BLAS.set_num_threads(Threads.nthreads()) # reset to default value?
