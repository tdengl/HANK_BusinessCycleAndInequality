...
@with_kw struct NumericalParameters
	...
	ny::Int             = 7  	# ngrid income (4 is the coarse grid used initially in finding the StE)
	...
	further_compress::Bool = true # remove non-volatile basis functions
