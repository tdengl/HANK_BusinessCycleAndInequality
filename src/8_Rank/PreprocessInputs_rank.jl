...
f = open("9_Rank_simple/prepare_linearization_rank.jl")
lines = readlines(f)
insert_index = findall( x -> x == "    # aggregate steady state marker", lines)[1]

g = open("9_Rank_simple/input_aggregate_steady_state_rank.jl")
s = read(g, String)

open("9_Rank_simple/prepare_linearization_generated_rank.jl", "w") do h
...
g = open("9_Rank_simple/input_aggregate_model_rank.jl")
s = read(g, String)

open("9_Rank_simple/FSYS_agg_generated.jl", "w") do h
